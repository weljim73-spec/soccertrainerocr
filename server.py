...
Required format:
{
  ...
  "left_kicking_power": number (mph - on the Two-footed detail screen, left side number next to "Kicking power" label - this is the LEFT FOOT kicking power, DIFFERENT from the max kicking_power above),
  "right_kicking_power": number (mph - on the Two-footed detail screen, right side number next to "Kicking power" label - this is the RIGHT FOOT kicking power, DIFFERENT from the max kicking_power above),
