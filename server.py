...
Required format:
{
  ...
  "left_kicking_power": number (mph - IMPORTANT: Look for "Left Foot Kicking Power: 23.49 mph" text on the two-footed detail screen, this is DIFFERENT from the max kicking_power above),
  "right_kicking_power": number (mph - IMPORTANT: Look for "Right Foot Kicking Power: 32.21 mph" text on the two-footed detail screen, this is DIFFERENT from the max kicking_power above),
