...
Required format:
{
  ...
  "kicking_power": number (mph - this is the MAX/highest kicking power),
  "left_touches": number (on the Two-footed detail screen - left side number next to "Touch" label, e.g. "5 (24%)" means left_touches=5),
  "left_touches_pct": number (percentage shown in parentheses next to left touches, e.g. 24),
  "right_touches": number (right side number next to "Touch" label, e.g. "16 (76%)" means right_touches=16),
  "right_touches_pct": number (percentage shown in parentheses next to right touches, e.g. 76),
  "left_releases": number (left side number next to "Release" label),
  "left_releases_pct": number (percentage in parentheses),
  "right_releases": number (right side number next to "Release" label),
  "right_releases_pct": number (percentage in parentheses),
  "left_receives": number (left side number next to "Receive" label),
  "left_receives_pct": number (percentage in parentheses),
  "right_receives": number (right side number next to "Receive" label),
  "right_receives_pct": number (percentage in parentheses),
  "left_kicking_power": number (mph - on the Two-footed detail screen, left side number next to "Kicking power" label, e.g. "32.44 mph  Kicking power  27.51 mph" means left_kicking_power=32.44. This is per-foot, DIFFERENT from the max kicking_power highlight above),
  "right_kicking_power": number (mph - on the Two-footed detail screen, right side number next to "Kicking power" label, e.g. "32.44 mph  Kicking power  27.51 mph" means right_kicking_power=27.51. This is per-foot, DIFFERENT from the max kicking_power highlight above),
